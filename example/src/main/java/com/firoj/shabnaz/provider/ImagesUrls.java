package com.firoj.shabnaz.provider;

public class ImagesUrls {

    public final static String[] imageUrls_left = new String[]{
            "http://shabnaaz.in/web/images/1.png",
            "http://shabnaaz.in/web/images/10.jpg",
            "http://shabnaaz.in/web/images/11.jpg",
    ...
    public final static String[] imageUrls_right = new String[]{
            "http://shabnaaz.in/web/images/2.png",
